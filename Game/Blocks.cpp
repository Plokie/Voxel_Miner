...
const map<BlockID, Block> BlockDef::def = {
	...
	{BlockID::WATER,	Block("Water", BLOCKSHAPE_BLOCK, CAT_NATURE, 4, 1, BT_DRAW_TRANSPARENT | BT_INDESTRUCTIBLE | BT_NONSOLID)},
	...
	{BlockID::OAK_LEAVES,	Block("Oak Leaves", BLOCKSHAPE_BLOCK, CAT_NATURE, 2, 1, BT_MINEABLE_ALL | BT_DRAW_CLIP | BT_NONSOLID, 0, "OAK_LEAVES")},
	...
	{BlockID::BIRCH_LEAVES,	Block("Birch Leaves", BLOCKSHAPE_BLOCK, CAT_NATURE, 2, 2, BT_MINEABLE_ALL | BT_DRAW_CLIP | BT_NONSOLID, 0, "BIRCH_LEAVES")},
	...
	{BlockID::CHERRY_LEAVES,	Block("Cherry Leaves", BLOCKSHAPE_BLOCK, CAT_NATURE, 2, 4, BT_MINEABLE_ALL | BT_DRAW_CLIP | BT_NONSOLID, 0, "CHERRY_LEAVES"
	)},
	...
	{BlockID::SPRUCE_LEAVES,	Block("Spruce Leaves", BLOCKSHAPE_BLOCK, CAT_NATURE, 2, 3, BT_MINEABLE_ALL | BT_DRAW_CLIP | BT_NONSOLID, 0, "SPRUCE_LEAVES" )},
	...
	{ BlockID::LAVA, Block("Lava", BLOCKSHAPE_BLOCK, CAT_NATURE, 4, 5, BT_DRAW_TRANSPARENT | BT_INDESTRUCTIBLE |BT_NONSOLID ) },
